...
print("\n\n" + "=" * 70)
print("ETAPA 5 — Regressão com MLP")
print("=" * 70)
...
# -------------------------------------------------------
print("\n" + "-" * 50)
print("5.1 — Preparação dos dados")
print("-" * 50)
...
print(f"Features preditivas ({len(features_reg)}): {features_reg}")
print(f"Variável alvo: '{TARGET_REG}' (escala original em mg/dL)")

X_train_reg, X_test_reg, y_train_reg, y_test_reg = train_test_split(
    X_reg, y_reg, test_size=0.2, random_state=42
)

print(f"Treino: {X_train_reg.shape[0]} amostras | Teste: {X_test_reg.shape[0]} amostras")

# -------------------------------------------------------
# 5.2 Definição e treinamento da MLP de Regressão
# -------------------------------------------------------
print("\n" + "-" * 50)
print("5.2 — Treinamento do MLPRegressor")
print("-" * 50)
...
print("Hiperparâmetros da MLP (Regressão):")
for k, v in MLP_REG_PARAMS.items():
    print(f"  {k}: {v}")
...
print(f"Convergiu em {mlp_reg.n_iter_} épocas ({time_mlp_reg:.2f}s)")

# -------------------------------------------------------
# 5.3 Avaliação do Modelo de Regressão
# -------------------------------------------------------
print("\n" + "-" * 50)
print("5.3 — Avaliação do Modelo")
print("-" * 50)
...
print("Métricas de Desempenho (em mg/dL):")
print(f"  MAE:  {mae:.2f}")
print(f"  MSE:  {mse:.2f}")
...
# -------------------------------------------------------
print("\n" + "-" * 50)
print("5.4 — Gerando visualizações…")
print("-" * 50)
...
plt.close(fig)
print(f"  ✓ {OUTPUT_DIR}/19_mlp_regressao_avaliacao.png")
